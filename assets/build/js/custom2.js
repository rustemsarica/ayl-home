		...
		function init_echarts() {
			...
			if ($('#echart_bar_horizontal').length ){ 
			  ...
			  echartBar.setOption({
				...
				yAxis: [{
				  type: 'category',
				  data: ['Jan', 'Feb', 'Mar', 'Apr', 'Mayıs', 'Jun']
				}],
				series: [{
				  name: '2015',
				  type: 'bar',
			...
			if ($('#echart_world_map').length ){ 
				  ...
				  echartMap.setOption({
					title: {
					  ...
					  subtext: 'from United Nations, Total population, both sexes combined, as of 1 Temmuz (thousands)',
					  x: 'center',
					  y: 'top'
					},
					tooltip: {
